...
class GenerateJWTTokenHandler {
	...
	constructor(tokenLogin, cookieLogin) {
		this._tokenLoginHandler = tokenLogin; // TODO: SHOULDN'T USE OTHER HANDLERS FOR THIS; SHOULD USE MANAGERS!
		this._cookieLoginHandler = cookieLogin; // TODO: SHOULDN'T USE OTHER HANDLERS FOR THIS; SHOULD USE MANAGERS!
