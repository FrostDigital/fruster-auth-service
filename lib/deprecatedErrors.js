...
const errorCode = {
	...
	impersonationNotAllowed: serviceId + ".403.2"
};
...
module.exports = {
	...
	impersonationNotAllowed: function() {
		return err(403, errorCode.impersonationNotAllowed, "User not allowed to impersonate", detail);
	}
